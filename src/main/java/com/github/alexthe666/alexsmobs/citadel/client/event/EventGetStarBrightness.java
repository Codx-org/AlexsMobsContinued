...
@OnlyIn(Dist.CLIENT)
//? if forge && >=1.21.6 {
/*public class EventGetStarBrightness extends net.minecraftforge.eventbus.api.event.MutableEvent {
    public static final net.minecraftforge.eventbus.api.bus.EventBus<EventGetStarBrightness> BUS =
            net.minecraftforge.eventbus.api.bus.EventBus.create(EventGetStarBrightness.class);
*///?} elif fabric {
/*public class EventGetStarBrightness extends com.github.alexthe666.alexsmobs.fabric.event.AMEvent {
    public static final com.github.alexthe666.alexsmobs.fabric.event.AMEventBus<EventGetStarBrightness> BUS =
            com.github.alexthe666.alexsmobs.fabric.event.AMEventBus.create(EventGetStarBrightness.class);
*///?} else {
