...
// NeoForge removed LogicalSidedProvider at 1.21.5 (ServerLifecycleHooks.getCurrentServer() is the
// server work-queue there); Forge kept it. Gate the imports out of the NeoForge ≥1.21.5 build.
//? if !((neoforge && >=1.21.5) || fabric) {
...
public final class Pathfinding {
    ...
    public static class CitadelThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(final @NotNull Runnable runnable) throws RuntimeException {
            //? if neoforge && >=1.21.5 {
            /*BlockableEventLoop<?> workqueue = net.neoforged.neoforge.server.ServerLifecycleHooks.getCurrentServer();
            *///?} elif fabric {
            /*BlockableEventLoop<?> workqueue = com.github.alexthe666.alexsmobs.fabric.AlexsMobsFabric.getServer();
            *///?} else {
