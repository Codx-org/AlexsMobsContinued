...
public class ItemFlutterPot extends Item implements DispensibleContainerItem {
    ...
    @Override
    //? if >=1.21.5 {
    /*public boolean emptyContents(net.minecraft.world.entity.LivingEntity p_150821_, Level p_150822_, BlockPos p_150823_, @org.jetbrains.annotations.Nullable BlockHitResult p_150824_) {
        return false;
    }
    *///?} else {
