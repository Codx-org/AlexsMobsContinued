...
public class EntityRoadrunner extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.1D, AMCompat.ingredientOf(AMTagRegistry.ROADRUNNER_BREEDABLES), false));
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        if (AMCompat.contains(compound, "FeatherTime")) {
            this.timeUntilNextFeather = AMCompat.getInt(compound, "FeatherTime");
        }
    ...
    *///?} else {
    ...
    public void aiStep() {
        ...
        if (!this.level().isClientSide() && this.isAlive() && !this.isBaby() && --this.timeUntilNextFeather <= 0) {
            AMCompat.spawnAtLocation(this, AMItemRegistry.ROADRUNNER_FEATHER.get());
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        return AMCompat.create(AMEntityRegistry.ROADRUNNER.get(), p_241840_1_);
    }
