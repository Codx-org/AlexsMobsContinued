    ...
    *///?} else {
    ...
    public void positionRider(Entity passenger, Entity.MoveFunction moveFunc) {
        if (this.hasPassenger(passenger)) {
            ...
            passenger.setPos(this.getX() + vec.x, this.getY() + vec.y + AMPlatform.myRidingOffset(passenger, this), this.getZ() + vec.z);
        }
    }
    ...
    *///?} else {
    ...
    //?}
        ...
        if (this.random.nextFloat() < 0.2F) {
            Drowned drowned = AMCompat.create(EntityType.DROWNED, level());
            //? if >=1.20.5 {
