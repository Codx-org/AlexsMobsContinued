...
public class EntityTusklin extends Animal implements IAnimatedEntity {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<Player>(this, Player.class, 100, true, false, com.github.alexthe666.alexsmobs.misc.AMCompat.selector(this::isAngryAt)));
    }
    ...
    *///?} else {
    ...
    public void addAdditionalSaveData(CompoundTag p_31808_) {
        ...
        if (!this.getShoeStack().isEmpty()) {
            AMCompat.put(p_31808_, "ShoeItem", com.github.alexthe666.alexsmobs.misc.AMCompat.saveItem(this.level().registryAccess(), this.getShoeStack()));
        }
    ...
    public void readAdditionalSaveData(CompoundTag p_31795_) {
        ...
        if (compoundtag != null && !compoundtag.isEmpty()) {
            ItemStack itemstack = com.github.alexthe666.alexsmobs.misc.AMCompat.loadItem(this.level().registryAccess(), compoundtag);
    ...
    public void tick() {
        ...
        if(isInNether()) {
            ...
            if (conversionTime > 300 && !this.level().isClientSide()) {
                //? if >=1.21.2 {
                /*// convertTo now finalises the spawn and removes the old entity itself, and the
                // post-conversion setup runs in the callback.
                this.convertTo(EntityType.HOGLIN, net.minecraft.world.entity.ConversionParams.single(this, false, false), hoglin -> {
    ...
    *///?} else {
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob mob) {
        return AMCompat.create(AMEntityRegistry.TUSKLIN.get(), level());
    }
}
