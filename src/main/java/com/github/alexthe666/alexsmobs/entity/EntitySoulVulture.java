...
/*// #104: 1.21.2 moved the default loot table onto EntityType and deleted getDefaultLootTable(),
    ...
    public java.util.Optional<net.minecraft.resources.ResourceKey<net.minecraft.world.level.storage.loot.LootTable>> getLootTable() {
        return hasSoulHeart() ? AMCompat.lootOpt(SOUL_LOOT) : super.getLootTable();
    }
    *///?} elif >=1.21.2 {
    ...
    *///?} elif >=1.20.5 {
    ...
    protected net.minecraft.resources.ResourceKey<net.minecraft.world.level.storage.loot.LootTable> getDefaultLootTable() {
        return hasSoulHeart() ? AMCompat.lootKey(SOUL_LOOT) : super.getDefaultLootTable();
    }
    *///?} else {
        ...
        public void tick() {
            ...
            if (vulture.getTarget() != null) {
                ...
                if (vulture.getBoundingBox().inflate(0.3F, 0.3F, 0.3F).intersects(vulture.getTarget().getBoundingBox()) && vulture.tackleCooldown == 0) {
                    ...
                    if(AMCompat.hurt(vulture.getTarget(), vulture.damageSources().mobAttack(vulture), dmg)){
