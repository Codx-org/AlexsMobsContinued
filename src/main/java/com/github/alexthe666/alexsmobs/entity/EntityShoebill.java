...
public class EntityShoebill extends Animal implements IAnimatedEntity, ITargetsDroppedItems {
    ...
    *///?} else {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(5, new TemptGoal(this, 1.1D, AMCompat.ingredientOf(AMTagRegistry.SHOEBILL_FOODSTUFFS), false));
        ...
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, EntityAlligatorSnappingTurtle.class, 40, false, false, AMCompat.selector(TARGET_BABY)));
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide() && this.getTarget() != null && this.getAnimation() == ANIMATION_ATTACK && this.getAnimationTick() == 9 && this.hasLineOfSight(this.getTarget())) {
            AMCompat.knockback(getTarget(), 0.3F, getTarget().getX() - this.getX(), getTarget().getZ() - this.getZ());
