    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.3D, true){
            protected double getAttackReachSqr(LivingEntity attackTarget) {
                return com.github.alexthe666.alexsmobs.misc.AMPlatform.attackReachSqr(this.mob, attackTarget) + 2.5D;
            }
...
*///?}
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.1D, AMCompat.ingredientOf(AMTagRegistry.EMU_BREEDABLES), false));
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide()) {
            ...
            if (this.isAlive() && target != null && this.getAnimation() == ANIMATION_SCRATCH && this.distanceTo(target) < 4F && (this.getAnimationTick() == 8 || this.getAnimationTick() == 15)) {
                ...
                AMCompat.knockback(target, 0.4F, target.getX() - this.getX(), target.getZ() - this.getZ());
        ...
        if (!this.level().isClientSide() && this.isAlive() && !this.isBaby() && --this.timeUntilNextEgg <= 0) {
            ...
            AMCompat.spawnAtLocation(this, AMItemRegistry.EMU_EGG.get());
