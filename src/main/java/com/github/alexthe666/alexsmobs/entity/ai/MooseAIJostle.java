...
public class MooseAIJostle extends Goal {
    ...
    private EntityMoose getNearbyMoose() {
        List<EntityMoose> listOfMeese = AMCompat.getNearbyEntities(this.world, EntityMoose.class, JOSTLE_PREDICATE, this.moose, this.moose.getBoundingBox().inflate(16.0D));
