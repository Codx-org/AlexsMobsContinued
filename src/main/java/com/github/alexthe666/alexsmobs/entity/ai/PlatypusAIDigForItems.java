...
public class PlatypusAIDigForItems extends Goal {
    ...
    private static List<ItemStack> getItemStacks(EntityPlatypus platypus) {
        LootTable loottable = com.github.alexthe666.alexsmobs.misc.AMCompat.lootTable(platypus.level().getServer(), platypus.superCharged ? PLATYPUS_REWARD_CHARGED : PLATYPUS_REWARD);
