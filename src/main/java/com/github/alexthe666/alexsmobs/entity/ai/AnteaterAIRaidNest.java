...
public class AnteaterAIRaidNest extends MoveToBlockGoal {
    ...
    private static List<ItemStack> getItemStacks(EntityAnteater anteater) {
        LootTable loottable = com.github.alexthe666.alexsmobs.misc.AMCompat.lootTable(anteater.level().getServer(), ANTEATER_REWARD);
    ...
    private void breakHiveEffect(){
        if (com.github.alexthe666.alexsmobs.misc.AMPlatform.mobGriefing(anteater.level(), anteater)) {
