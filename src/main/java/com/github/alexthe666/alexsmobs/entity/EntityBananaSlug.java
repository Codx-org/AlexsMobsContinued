...
public class EntityBananaSlug extends Animal {
    ...
    *///?} else {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new TemptGoal(this, 1.0D, AMCompat.ingredientOf(AMTagRegistry.BANANA_SLUG_BREEDABLES), false));
    ...
    public void tick(){
        ...
        if (!this.level().isClientSide() && this.isAlive() && !this.isBaby() && --this.timeUntilSlime <= 0) {
            AMCompat.spawnAtLocation(this, AMItemRegistry.BANANA_SLUG_SLIME.get());
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob mob) {
        EntityBananaSlug slug = AMCompat.create(AMEntityRegistry.BANANA_SLUG.get(), level());
