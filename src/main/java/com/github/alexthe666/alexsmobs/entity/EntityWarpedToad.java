...
public class EntityWarpedToad extends TamableAnimal implements ITargetsDroppedItems, IFollower, ISemiAquatic {
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        this.setOrderedToSit(AMCompat.getBoolean(compound, "ToadSitting"));
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.0D, AMCompat.ingredientOf(AMTagRegistry.WARPED_TOAD_FOODSTUFFS), false));
...
//            }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageableEntity) {
        return AMCompat.create(AMEntityRegistry.WARPED_TOAD.get(), serverWorld);
    }
