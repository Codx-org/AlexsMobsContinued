...
public class EntityBlueJay extends Animal implements ITargetsDroppedItems{
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new FlyingAITempt(this, 1.0D, AMCompat.ingredientOf(AMTagRegistry.BLUE_JAY_FOODSTUFFS), false));
    ...
    *///?} else {
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob mob) {
        return AMCompat.create(AMEntityRegistry.BLUE_JAY.get(), level());
    }
