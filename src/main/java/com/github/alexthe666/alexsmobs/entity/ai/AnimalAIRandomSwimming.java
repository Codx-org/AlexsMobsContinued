...
public class AnimalAIRandomSwimming extends RandomStrollGoal {
    ...
    protected Vec3 getPosition() {
        ...
        for(int i = 0; vector3d != null && !AMCompat.isPathfindable(this.mob.level().getBlockState(AMBlockPos.fromVec3(vector3d)), this.mob.level(), AMBlockPos.fromVec3(vector3d), PathComputationType.WATER) && i++ < 15; vector3d = DefaultRandomPos.getPos(this.mob, 10, ySpread)) {
        }
