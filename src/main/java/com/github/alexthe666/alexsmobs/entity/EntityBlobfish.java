...
public class EntityBlobfish extends WaterAnimal implements FlyingAnimal, Bucketable {
    ...
    *///?} else {
    ...
    public EntityDimensions getDimensions(Pose poseIn) {
        EntityDimensions dimensions = super.getDimensions(poseIn).scale(this.getBlobfishScale());
    ...
    *///?} else {
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        this.setSlimed(AMCompat.getBoolean(compound, "Slimed"));
        this.setBlobfishScale(AMCompat.getFloat(compound, "BlobfishScale"));
    }
    ...
    public void loadFromBucketTag(@Nonnull CompoundTag compound) {
        ...
        if (AMCompat.contains(compound, "BucketScale")){
            this.setBlobfishScale(AMCompat.getFloat(compound, "BucketScale"));
        }
        if (AMCompat.contains(compound, "Slimed")){
            this.setSlimed(AMCompat.getBoolean(compound, "Slimed"));
        }
    }
