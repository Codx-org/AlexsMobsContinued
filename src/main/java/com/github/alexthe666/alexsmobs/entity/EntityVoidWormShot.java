...
public class EntityVoidWormShot extends Entity {
    ...
    protected void onEntityHit(EntityHitResult p_213868_1_) {
        ...
        if (entity instanceof LivingEntity && !(p_213868_1_.getEntity() instanceof EntityVoidWorm || p_213868_1_.getEntity() instanceof EntityVoidWormPart)) {
            ...
            if(b && p_213868_1_.getEntity() instanceof Player){
                ...
                if(AMCompat.canShieldBlock(player.getUseItem())){
                    // 1.20.5 dropped disableShield's "increase cooldown" flag; 1.21.2 made it take
                    // the shield stack; 1.21.5 removed Player#disableShield outright, so replicate its
                    // effect (stop blocking + put the shield on cooldown) by hand.
                    //? if >=1.21.5 {
                    /*net.minecraft.world.item.ItemStack amShield = player.getUseItem().copy();
                    player.stopUsingItem();
                    player.getCooldowns().addCooldown(amShield, 100);
                    *///?} elif >=1.21.2 {
    ...
    *///?} else {
    ...
    protected void readAdditionalSaveData(CompoundTag compound) {
        ...
        this.setStopHomingProgress(AMCompat.getFloat(compound, "HomeTime"));
