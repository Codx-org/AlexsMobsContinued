...
public class BoneSerpentPathNavigator extends PathNavigation {
    ...
    // 1.21.6 added an abstract canNavigateGround() to PathNavigation. The bone serpent swims
    // through lava, so it answers the same as vanilla's WaterBoundPathNavigation.
    //? if >=1.21.6 {
    /*@Override
