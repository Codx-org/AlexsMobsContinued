...
public class EntityGust extends Entity {
    ...
    *///?} else {
    ...
    protected void readAdditionalSaveData(CompoundTag compound) {
        this.entityData.set(X_DIR, com.github.alexthe666.alexsmobs.misc.AMCompat.getFloat(compound, "GustDirX"));
        this.entityData.set(Y_DIR, com.github.alexthe666.alexsmobs.misc.AMCompat.getFloat(compound, "GustDirX"));
        this.entityData.set(Z_DIR, com.github.alexthe666.alexsmobs.misc.AMCompat.getFloat(compound, "GustDirX"));
