...
public enum TerrapinTypes {
    ...
    GREEN(AMCompat.rl("alexsmobs:textures/entity/terrapin/terrapin_green.png"), 8.0F),
    BLACK(AMCompat.rl("alexsmobs:textures/entity/terrapin/terrapin_black.png"), 11.0F),
    BROWN(AMCompat.rl("alexsmobs:textures/entity/terrapin/terrapin_brown.png"), 10.0F),
    KOOPA(AMCompat.rl("alexsmobs:textures/entity/terrapin/terrapin_koopa.png"), 0.05F),
    PAINTED(AMCompat.rl("alexsmobs:textures/entity/terrapin/terrapin_painted.png"), 8.0F),
    RED_EARED(AMCompat.rl("alexsmobs:textures/entity/terrapin/terrapin_red_eared.png"), 13.0F),
    OVERLAY(AMCompat.rl("alexsmobs:textures/entity/terrapin/overlay/terrapin_with_overlays.png"), 9.0F);
