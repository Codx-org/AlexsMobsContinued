    ...
    *///?} else {
    ...
    protected void onEntityHit(EntityHitResult result) {
        ...
        if (entity instanceof LivingEntity) {
            boolean b = AMCompat.hurt(result.getEntity(), damageSources().mobProjectile(this, (LivingEntity) entity), this.getDamage());
    ...
    public boolean isSameTeam(Entity shooter, Entity entity) {
        if(shooter instanceof TamableAnimal tamableAnimal && tamableAnimal.isTame()){
            if(entity instanceof TamableAnimal alsoTameable && alsoTameable.isTame()){
                if(AMCompat.getOwnerUUID(alsoTameable) != null && AMCompat.getOwnerUUID(tamableAnimal) != null && AMCompat.getOwnerUUID(tamableAnimal).equals(AMCompat.getOwnerUUID(alsoTameable))){
                    return true;
                }
            }
            return AMCompat.getOwnerUUID(tamableAnimal) != null && AMCompat.getOwnerUUID(tamableAnimal).equals(entity.getUUID()) || shooter.isAlliedTo(entity);
        }
