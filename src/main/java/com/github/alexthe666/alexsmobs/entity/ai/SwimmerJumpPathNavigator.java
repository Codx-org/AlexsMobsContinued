...
public class SwimmerJumpPathNavigator  extends PathNavigation {
    ...
    // 1.21.6 added an abstract canNavigateGround() to PathNavigation. This one paths with a
    // SwimNodeEvaluator, so it answers the same as vanilla's WaterBoundPathNavigation.
    //? if >=1.21.6 {
    /*@Override
