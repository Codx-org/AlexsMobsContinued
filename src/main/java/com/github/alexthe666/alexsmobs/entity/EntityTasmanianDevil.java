...
public class EntityTasmanianDevil extends Animal implements IAnimatedEntity, ITargetsDroppedItems {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new TemptGoal(this, 1.1D, AMCompat.ingredientOf(AMTagRegistry.TASMANIAN_DEVIL_HOWLING_FOODS), false){
            public void tick(){
                super.tick();
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, Animal.class, 120, false, false, AMCompat.selector((p_213487_0_) -> {
    ...
    public void killed(ServerLevel world, LivingEntity entity) {
        if(this.getRandom().nextBoolean() && (entity instanceof Animal || AMCompat.isUndead(entity))){
            AMCompat.spawnAtLocation(entity, new ItemStack(Items.BONE));
        }
    }
    ...
    *///?} else {
    ...
    public boolean isFood(ItemStack stack) {
        return AMCompat.isEdible(stack.getItem()) && AMCompat.getFoodProperties(stack.getItem()) != null && AMCompat.isMeat(stack.getItem()) && !stack.is(AMTagRegistry.TASMANIAN_DEVIL_HOWLING_FOODS);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageableEntity) {
        return AMCompat.create(AMEntityRegistry.TASMANIAN_DEVIL.get(), serverWorld);
    }

    @Override
    public boolean canTargetItem(ItemStack stack) {
        return AMCompat.isEdible(stack.getItem()) && AMCompat.getFoodProperties(stack.getItem()) != null && AMCompat.isMeat(stack.getItem()) || stack.getItem() == Items.BONE;
    }
    ...
    public void dropBonemeal(){
        ...
        for(int i = 0; i < 3 + random.nextInt(1); i++){
            AMCompat.spawnAtLocation(this, stack);
        }
    }
}
