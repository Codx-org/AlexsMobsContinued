...
public class EntitySquidGrapple extends Entity {
    ...
    *///?} else {
    ...
    // Upstream had these two bodies swapped — it read the owner in addAdditionalSaveData and wrote
    // it in readAdditionalSaveData. That compiled while both hooks took a CompoundTag (which does
    // both get and put), so the grapple simply never persisted its owner.
    @Override
