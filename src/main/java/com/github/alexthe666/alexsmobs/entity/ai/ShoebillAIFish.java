...
public class ShoebillAIFish extends Goal {
    ...
    public void spawnFishingLoot() {
        ...
        //? if >=1.21.2 {
        /*net.minecraft.util.context.ContextKeySet.Builder lootparameterset$builder = new net.minecraft.util.context.ContextKeySet.Builder();
        *///?} else {
        LootContextParamSet.Builder lootparameterset$builder = new LootContextParamSet.Builder();
        //?}
        LootTable loottable = com.github.alexthe666.alexsmobs.misc.AMCompat.fishingLoot(bird.level().getServer());
