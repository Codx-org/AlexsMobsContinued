...
public class EntityDevilsHolePupfish extends WaterAnimal implements FlyingAnimal, Bucketable {
    ...
    *///?}
    ...
    private static List<ItemStack> getFoodLoot(EntityDevilsHolePupfish pupfish) {
        LootTable loottable = com.github.alexthe666.alexsmobs.misc.AMCompat.lootTable(pupfish.level().getServer(), PUPFISH_REWARD);
    ...
    private void spawnBabiesWith(EntityDevilsHolePupfish chasePartner) {
        EntityDevilsHolePupfish baby = AMCompat.create(AMEntityRegistry.DEVILS_HOLE_PUPFISH.get(), level());
                        ...
                        if(random.nextInt(3) == 0){
                            ...
                            if (!lootList.isEmpty()) {
                                for (ItemStack stack : lootList) {
                                    ItemEntity e = AMCompat.spawnAtLocation(pupfish, stack.copy());
                                    e.hasImpulse = true;
