...
public class AMConfig {
    ...
    public static int straddleboardBaseColor = 0xFFFFFF;
    public static int straddleboardPanelColor = 0xADC3D7;
    ...
    // The ModConfig parameter this used to take was never read — every value comes off
    // ConfigHolder.COMMON. Dropping it is what keeps this file free of net.minecraftforge.**,
    // so it needs no loader gate on Fabric.
    public static void bake() {
        try {
            ...
            straddleboardBaseColor = ConfigHolder.COMMON.straddleboardBaseColor.get();
            straddleboardPanelColor = ConfigHolder.COMMON.straddleboardPanelColor.get();
