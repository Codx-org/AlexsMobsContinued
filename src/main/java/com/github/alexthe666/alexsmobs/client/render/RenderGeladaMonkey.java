...
public class RenderGeladaMonkey extends MobRenderer<EntityGeladaMonkey, ModelGeladaMonkey> {
    private static final ResourceLocation TEXTURE = AMCompat.rl("alexsmobs:textures/entity/gelada_monkey.png");
    private static final ResourceLocation TEXTURE_ANGRY = AMCompat.rl("alexsmobs:textures/entity/gelada_monkey_angry.png");
    private static final ResourceLocation TEXTURE_LEADER = AMCompat.rl("alexsmobs:textures/entity/gelada_monkey_leader.png");
    private static final ResourceLocation TEXTURE_LEADER_ANGRY = AMCompat.rl("alexsmobs:textures/entity/gelada_monkey_leader_angry.png");
