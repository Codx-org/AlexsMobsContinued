...
public class ModelRockyChestplate extends HumanoidModel{
    ...
    // Empty by design (the chestplate is unposed) and rendered manually via renderToBuffer, not as
    // a vanilla layer. HumanoidModel#setupAnim took the entity through 1.21.1 and the render state
    // from 1.21.2 on, so this stops being an @Override there — it stays a plain 6-arg overload the
    // manual call site in ClientEvents still resolves.
    //? if <1.21.2 {
    @Override
    //?}
