...
public class RenderMantisShrimp extends MobRenderer<EntityMantisShrimp, ModelMantisShrimp> {
    private static final ResourceLocation TEXTURE_0 = AMCompat.rl("alexsmobs:textures/entity/mantis_shrimp_0.png");
    private static final ResourceLocation TEXTURE_1 = AMCompat.rl("alexsmobs:textures/entity/mantis_shrimp_1.png");
    private static final ResourceLocation TEXTURE_2 = AMCompat.rl("alexsmobs:textures/entity/mantis_shrimp_2.png");
    private static final ResourceLocation TEXTURE_3 = AMCompat.rl("alexsmobs:textures/entity/mantis_shrimp_3.png");
