...
public class RenderMudBall extends EntityRenderer<EntityMudBall> {
    private static final ResourceLocation TEXTURE = AMCompat.rl("alexsmobs:textures/entity/mud_ball.png");
    ...
    public void render(EntityMudBall entityMudBall, float f, float f2, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        ...
        p_114083_.mulPose(com.github.alexthe666.alexsmobs.client.render.AMRenderCompat.cameraOrientation(this.entityRenderDispatcher));
    ...
    private static void vertex(VertexConsumer p_114090_, Matrix4f p_114091_, Matrix3f p_114092_, int p_114093_, float p_114094_, int p_114095_, int p_114096_, int p_114097_) {
        com.github.alexthe666.alexsmobs.client.render.AMVertex.normal(p_114090_.vertex(p_114091_, p_114094_ - 0.5F, (float)p_114095_ - 0.25F, 0.0F).color(255, 255, 255, 255).uv((float)p_114096_, (float)p_114097_).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(p_114093_), p_114092_, 0.0F, 1.0F, 0.0F).endVertex();
    }
