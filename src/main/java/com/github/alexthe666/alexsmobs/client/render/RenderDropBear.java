...
public class RenderDropBear extends MobRenderer<EntityDropBear, ModelDropBear> {
    private static final ResourceLocation TEXTURE = AMCompat.rl("alexsmobs:textures/entity/dropbear.png");
    private static final ResourceLocation TEXTURE_EYES = AMCompat.rl("alexsmobs:textures/entity/dropbear_eyes.png");
