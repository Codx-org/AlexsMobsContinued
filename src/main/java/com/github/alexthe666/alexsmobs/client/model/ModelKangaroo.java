...
public class ModelKangaroo extends AdvancedEntityModel<EntityKangaroo> {
	...
	public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
		...
		animator.endKeyframe();
		animator.resetKeyframe(5);
		// Not upstream (#59): the spear thrust. Unlike the punches this one holds its wound-up pose
		// for five ticks before it commits, so the weapon is visibly cocked over the shoulder first.
		// The held item hangs off the main-hand arm (LayerKangarooItem#translateToHand), so raising
		// that arm carries the spear with it; the two variants differ only in which arm that is.
		animator.setAnimation(EntityKangaroo.ANIMATION_STAB_R);
		animator.startKeyframe(5);
		animator.rotate(chest, Maths.rad(-15), Maths.rad(-25), 0);
		animator.rotate(neck, Maths.rad(5), Maths.rad(25), 0);
		animator.rotate(head, 0, Maths.rad(10), 0);
		animator.rotate(arm_right, Maths.rad(-145), 0, Maths.rad(20));
		animator.rotate(arm_left, Maths.rad(-50), 0, Maths.rad(-15));
		animator.endKeyframe();
		animator.setStaticKeyframe(5);
		animator.startKeyframe(3);
		animator.move(chest, 0, 0, -2);
		animator.rotate(chest, Maths.rad(20), Maths.rad(10), 0);
		animator.rotate(neck, Maths.rad(-15), Maths.rad(-10), 0);
		animator.rotate(arm_right, Maths.rad(-100), 0, Maths.rad(5));
		animator.rotate(arm_left, Maths.rad(-20), 0, 0);
		animator.endKeyframe();
		animator.setStaticKeyframe(2);
		animator.resetKeyframe(6);
		animator.setAnimation(EntityKangaroo.ANIMATION_STAB_L);
		animator.startKeyframe(5);
		animator.rotate(chest, Maths.rad(-15), Maths.rad(25), 0);
		animator.rotate(neck, Maths.rad(5), Maths.rad(-25), 0);
		animator.rotate(head, 0, Maths.rad(-10), 0);
		animator.rotate(arm_left, Maths.rad(-145), 0, Maths.rad(-20));
		...
		animator.rotate(chest, Maths.rad(20), Maths.rad(-10), 0);
		animator.rotate(neck, Maths.rad(-15), Maths.rad(10), 0);
		animator.rotate(arm_left, Maths.rad(-100), 0, Maths.rad(-5));
		animator.rotate(arm_right, Maths.rad(-20), 0, 0);
		animator.endKeyframe();
		animator.setStaticKeyframe(2);
		animator.resetKeyframe(6);
