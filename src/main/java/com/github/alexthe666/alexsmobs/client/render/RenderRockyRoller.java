...
public class RenderRockyRoller extends MobRenderer<EntityRockyRoller, ModelRockyRoller> {
    private static final ResourceLocation TEXTURE = AMCompat.rl("alexsmobs:textures/entity/rocky_roller.png");
    private static final ResourceLocation TEXTURE_ANGRY = AMCompat.rl("alexsmobs:textures/entity/rocky_roller_angry.png");
    private static final ResourceLocation TEXTURE_ROLLING = AMCompat.rl("alexsmobs:textures/entity/rocky_roller_rolling.png");
