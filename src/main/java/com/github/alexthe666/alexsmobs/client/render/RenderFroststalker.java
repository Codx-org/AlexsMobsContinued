...
public class RenderFroststalker extends MobRenderer<EntityFroststalker, ModelFroststalker> {
    private static final ResourceLocation TEXTURE = AMCompat.rl("alexsmobs:textures/entity/froststalker.png");
    private static final ResourceLocation TEXTURE_NOSPIKES = AMCompat.rl("alexsmobs:textures/entity/froststalker_nospikes.png");
