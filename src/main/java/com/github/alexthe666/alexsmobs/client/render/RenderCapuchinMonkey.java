...
public class RenderCapuchinMonkey extends MobRenderer<EntityCapuchinMonkey, ModelCapuchinMonkey> {
    private static final ResourceLocation TEXTURE_0 = AMCompat.rl("alexsmobs:textures/entity/capuchin_monkey_0.png");
    private static final ResourceLocation TEXTURE_1 = AMCompat.rl("alexsmobs:textures/entity/capuchin_monkey_1.png");
    private static final ResourceLocation TEXTURE_2 = AMCompat.rl("alexsmobs:textures/entity/capuchin_monkey_2.png");
    private static final ResourceLocation TEXTURE_3 = AMCompat.rl("alexsmobs:textures/entity/capuchin_monkey_3.png");
