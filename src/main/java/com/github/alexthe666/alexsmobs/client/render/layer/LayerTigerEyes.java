...
public class LayerTigerEyes  extends RenderLayer<EntityTiger, ModelTiger> {
    private static final ResourceLocation TEXTURE = AMCompat.rl("alexsmobs:textures/entity/tiger/tiger_eyes.png");
    private static final ResourceLocation TEXTURE_WHITE = AMCompat.rl("alexsmobs:textures/entity/tiger/tiger_white_eyes.png");
    private static final ResourceLocation TEXTURE_ANGRY = AMCompat.rl("alexsmobs:textures/entity/tiger/tiger_angry_eyes.png");
