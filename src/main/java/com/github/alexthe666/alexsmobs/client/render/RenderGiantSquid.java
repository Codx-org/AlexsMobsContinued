...
public class RenderGiantSquid extends MobRenderer<EntityGiantSquid, ModelGiantSquid> {
    private static final ResourceLocation TEXTURE = AMCompat.rl("alexsmobs:textures/entity/giant_squid.png");
    private static final ResourceLocation TEXTURE_BLUE = AMCompat.rl("alexsmobs:textures/entity/giant_squid_blue.png");
    private static final ResourceLocation TEXTURE_DEPRESSURIZED = AMCompat.rl("alexsmobs:textures/entity/giant_squid_depressurized.png");
