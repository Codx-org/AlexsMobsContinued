...
public class ModelUnsettlingKimono extends HumanoidModel {
    ...
    // See ModelRockyChestplate: empty, manually rendered, so it drops @Override on >=1.21.2 where
    // HumanoidModel#setupAnim switched to the render state, and remains a plain 6-arg overload.
    //? if <1.21.2 {
    @Override
    //?}
