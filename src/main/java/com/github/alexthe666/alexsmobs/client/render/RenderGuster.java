...
public class RenderGuster extends MobRenderer<EntityGuster, ModelGuster> {
    private static final ResourceLocation TEXTURE = AMCompat.rl("alexsmobs:textures/entity/guster.png");
    private static final ResourceLocation TEXTURE_GOOGLY = AMCompat.rl("alexsmobs:textures/entity/guster_silly.png");
    private static final ResourceLocation TEXTURE_EYES = AMCompat.rl("alexsmobs:textures/entity/guster_eye.png");
    private static final ResourceLocation TEXTURE_RED = AMCompat.rl("alexsmobs:textures/entity/guster_red.png");
    private static final ResourceLocation TEXTURE_SOUL = AMCompat.rl("alexsmobs:textures/entity/guster_soul.png");
    private static final ResourceLocation TEXTURE_SOUL_EYES = AMCompat.rl("alexsmobs:textures/entity/guster_eye_soul.png");
    ...
    /** ⚠️ A {@link RenderLayer}, not vanilla's {@code EyesLayer} — see {@code RenderEnderiophage}. */
    static class GusterEyesLayer extends RenderLayer<EntityGuster, ModelGuster> {
