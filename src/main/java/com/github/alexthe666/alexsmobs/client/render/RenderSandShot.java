...
public class RenderSandShot extends EntityRenderer<EntitySandShot> {
    private static final ResourceLocation SAND_SHOT = AMCompat.rl("alexsmobs:textures/entity/sand_shot.png");
    ...
    public void render(EntitySandShot entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        com.github.alexthe666.alexsmobs.client.render.AMRenderCompat.renderToBuffer(this.model, matrixStackIn, ivertexbuilder, packedLightIn, OverlayTexture.NO_OVERLAY, r, g, b, 1.0F);
