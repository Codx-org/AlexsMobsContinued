...
public class RenderEndPirateAnchor<T extends TileEntityEndPirateAnchor> implements BlockEntityRenderer<T> {
    ...
    protected static final ResourceLocation TEXTURE_ANCHOR = AMCompat.rl("alexsmobs:textures/entity/end_pirate/anchor.png");
    protected static final ResourceLocation TEXTURE_ANCHOR_GLOW = AMCompat.rl("alexsmobs:textures/entity/end_pirate/anchor_glow.png");
