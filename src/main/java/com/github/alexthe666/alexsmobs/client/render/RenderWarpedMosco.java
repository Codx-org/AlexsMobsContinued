...
public class RenderWarpedMosco extends MobRenderer<EntityWarpedMosco, ModelWarpedMosco> {
    private static final ResourceLocation TEXTURE = AMCompat.rl("alexsmobs:textures/entity/warped_mosco.png");
    private static final ResourceLocation TEXTURE_EYES = AMCompat.rl("alexsmobs:textures/entity/warped_mosco_glow.png");
