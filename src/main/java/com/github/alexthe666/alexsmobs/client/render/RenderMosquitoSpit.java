...
public class RenderMosquitoSpit extends EntityRenderer<EntityMosquitoSpit> {
    private static final ResourceLocation SPIT_TEXTURE = AMCompat.rl("alexsmobs:textures/entity/mosquito_spit.png");
    ...
    public void render(EntityMosquitoSpit entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        com.github.alexthe666.alexsmobs.client.render.AMRenderCompat.renderToBuffer(this.model, matrixStackIn, ivertexbuilder, 240, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
