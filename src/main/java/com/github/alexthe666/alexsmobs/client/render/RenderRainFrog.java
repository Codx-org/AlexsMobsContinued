...
public class RenderRainFrog extends MobRenderer<EntityRainFrog, ModelRainFrog> {
    private static final ResourceLocation TEXTURE_0 = AMCompat.rl("alexsmobs:textures/entity/rain_frog_0.png");
    private static final ResourceLocation TEXTURE_1 = AMCompat.rl("alexsmobs:textures/entity/rain_frog_1.png");
    private static final ResourceLocation TEXTURE_2 = AMCompat.rl("alexsmobs:textures/entity/rain_frog_2.png");
