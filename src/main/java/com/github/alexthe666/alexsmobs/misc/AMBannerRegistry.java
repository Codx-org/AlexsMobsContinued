...
public class AMBannerRegistry {
    ...
    // 1.20.5 turned banner patterns into a datapack registry — the five AM patterns now
    // ship as data/alexsmobs/banner_pattern/*.json and nothing is registered from code.
    //? if <1.20.5 {
    static{
