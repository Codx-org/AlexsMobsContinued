...
public class AMDamageTypes {
    ...
    public static final ResourceKey<DamageType> FARSEER = ResourceKey.create(Registries.DAMAGE_TYPE, AMCompat.rl("alexsmobs:farseer"));
    public static final ResourceKey<DamageType> FREDDY = ResourceKey.create(Registries.DAMAGE_TYPE, AMCompat.rl("alexsmobs:freddy"));
