...
public class AMTagRegistry {
    ...
    // 1.20.5 replaced EnchantmentCategory with a supported-items item tag.
    public static final TagKey<Item> STRADDLEBOARD_ENCHANTABLE = registerItemTag("straddleboard_enchantable");
    ...
    // Not upstream: weapons a kangaroo winds up with instead of jabbing (see EntityKangaroo#ANIMATION_STAB_R).
    public static final TagKey<Item> KANGAROO_SPEARS = registerItemTag("kangaroo_spears");
    ...
    private static TagKey<EntityType<?>> registerEntityTag(String name) {
        return TagKey.create(Registries.ENTITY_TYPE, AMCompat.rl(AlexsMobs.MODID, name));
    }

    private static TagKey<Item> registerItemTag(String name) {
        return TagKey.create(Registries.ITEM, AMCompat.rl(AlexsMobs.MODID, name));
    }

    private static TagKey<Block> registerBlockTag(String name) {
        return TagKey.create(Registries.BLOCK, AMCompat.rl(AlexsMobs.MODID, name));
    }

    private static TagKey<Biome> registerBiomeTag(String name) {
        return TagKey.create(Registries.BIOME, AMCompat.rl(AlexsMobs.MODID, name));
    }

    private static TagKey<Structure> registerStructureTag(String name) {
        return TagKey.create(Registries.STRUCTURE, AMCompat.rl(AlexsMobs.MODID, name));
    }
}
